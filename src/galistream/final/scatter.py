...
def plot(momentum,result):
    ...
    ax.text(0.25, 0.95, 'A', transform=ax.transAxes, fontsize=20, fontweight='bold', va='top', ha='right')
    ax.text(0.50, 0.95, 'B', transform=ax.transAxes, fontsize=20, fontweight='bold', va='top', ha='right')
    ax.text(0.75, 0.95, 'C', transform=ax.transAxes, fontsize=20, fontweight='bold', va='top', ha='right')
    ax.set_yticks([])
    ax.set_xticks([])
    ax.set_xlabel(r"Angular Momentum $L_z$ (kpc km s${}^{-1}$)")
    ax.set_ylabel(r"Total Energy $E$ (km${}^2$ s${}^{-2}$)")
