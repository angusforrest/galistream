...
def plot(d0_0,d1250_0,d1250_1,d1250_2,d2500_0,d2500_1,d2500_2,d5000_0,d5000_1):
    ...
    ax.text(ts[12],6.5,"A",bbox=bbox,horizontalalignment='centre')
    ax.axvline(ts[16],0,6.5,linestyle='dashed')
    ax.text(ts[16],6.5,"B",bbox=bbox,horizontalalignment='centre')
    ax.axvline(ts[20],0,6.5,linestyle='dashed')
    ax.text(ts[20],6.5,"C",bbox=bbox,horizontalalignment='centre')
    ax.axvline(ts[25],0,6.5,linestyle='dashed')
    ax.text(ts[25],6.5,"D",bbox=bbox,horizontalalignment='centre')
    ax.axvline(ts[33],0,6.5,linestyle='dashed')
    ax.text(ts[33],6.5,"E",bbox=bbox,horizontalalignment='centre')
    ax.axvline(ts[39],0,6.5,linestyle='dashed')
    ax.text(ts[39],6.5,"F",bbox=bbox,horizontalalignment='centre')
