...
def plot(d0_0,d1250_0,d1250_1,d1250_2,d2500_0,d2500_1,d2500_2,d5000_0,d5000_1):
    ...
    ts = d1250_0[-1]
    ax[0,0].plot(ts,d1250_0[1],c="blue",label="1250")
    ax[0,0].plot(ts,d1250_1[1],c="blue")
    ax[0,0].plot(ts,d1250_2[1],c="blue")
    ax[0,0].plot(ts,d2500_0[1],c="green",label="2500")
    ax[0,0].plot(ts,d2500_1[1],c="green")
    ax[0,0].plot(ts,d2500_2[1],c="green")
    ax[0,0].plot(ts,d5000_0[1],c="red",label="5000")
    ax[0,0].plot(ts,d5000_1[1],c="red")
    ax[0,0].legend(loc="upper left")
    ax[0,0].set_xlabel("time (Gyr)")
    ax[0,0].set_ylabel(r'$\sigma^2 = \Delta E$')
    ax[0,0].set_xlim(0,1)
    ts = d1250_0[-1]
    bbox = dict(boxstyle='round', fc='blanchedalmond', ec='orange', alpha=1)
    ax[0,1].axvline(ts[12],0,0.95,linestyle='dashed')
    ax[0,1].text(ts[12],6.5,"A",bbox=bbox,horizontalalignment='center')
    ax[0,1].axvline(ts[16],0,0.95,linestyle='dashed')
    ax[0,1].text(ts[16],6.5,"B",bbox=bbox,horizontalalignment='center')
    ax[0,1].axvline(ts[20],0,0.95,linestyle='dashed')
    ax[0,1].text(ts[20],6.5,"C",bbox=bbox,horizontalalignment='center')
    ax[0,1].axvline(ts[25],0,0.95,linestyle='dashed')
    ax[0,1].text(ts[25],6.5,"D",bbox=bbox,horizontalalignment='center')
    ax[0,1].axvline(ts[33],0,0.95,linestyle='dashed')
    ax[0,1].text(ts[33],6.5,"E",bbox=bbox,horizontalalignment='center')
    ax[0,1].axvline(ts[39],0,0.95,linestyle='dashed')
    ax[0,1].text(ts[39],6.5,"F",bbox=bbox,horizontalalignment='center')
    ax[0,1].plot(ts,numpy.sqrt(d1250_0[1]),c="blue",label="1250")
    ax[0,1].plot(ts,numpy.sqrt(d1250_1[1]),c="blue")
    ax[0,1].plot(ts,numpy.sqrt(d1250_2[1]),c="blue")
    ax[0,1].plot(ts,numpy.sqrt(d2500_0[1]),c="green",label="2500")
    ax[0,1].plot(ts,numpy.sqrt(d2500_1[1]),c="green")
    ax[0,1].plot(ts,numpy.sqrt(d2500_2[1]),c="green")
    ax[0,1].plot(ts,numpy.sqrt(d5000_0[1]),c="red",label="5000")
    ax[0,1].plot(ts,numpy.sqrt(d5000_1[1]),c="red")
    ax[0,1].legend(loc="upper left")
    ax[0,1].set_xlabel("time (Gyr)")
    ax[0,1].set_ylabel(r'$\sigma = \sqrt{\Delta E}$')
    ax[0,1].set_xlim(0,1)
