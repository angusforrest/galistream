...
def plot(orbits):
    ...
    ax[1,0].text(0.05, 0.05, 'B', transform=ax[1,0].transAxes, fontsize=10, fontweight='bold', va='bottom', ha='left')
    ...
    ax[1,1].text(0.05, 0.05, 'D', transform=ax[1,1].transAxes, fontsize=10, fontweight='bold', va='bottom', ha='left')
