...
def plot_state(truth,deflect):
	...
	ax[0, 1].plot(ts, orbit0.vx(ts))
	ax[1, 1].plot(ts, orbit0.vy(ts))
	ax[2, 1].plot(ts, orbit0.vz(ts))
	ax[0, 0].plot(ts, orbit1.x(ts))
	ax[1, 0].plot(ts, orbit1.y(ts))
	ax[2, 0].plot(ts, orbit1.z(ts))
	ax[0, 1].plot(ts, orbit1.vx(ts))
	ax[1, 1].plot(ts, orbit1.vy(ts))
	ax[2, 1].plot(ts, orbit1.vz(ts))
