...
def plot_scatter(orbits,gmc,t):
    ...
    select = orbits.z(t) > 0
    ax.scatter(orbits.x(t)[select],orbits.y(t)[select],orbits.z(t)[select],zorder=1,s=1)
    ax.scatter(orbits.x(t)[numpy.logical_not(select)],orbits.y(t)[numpy.logical_not(select)],orbits.z(t)[numpy.logical_not(select)],zorder=-1,s=1)
    ax.set_xlim(-10,10)
    ax.set_ylim(-10,10)
    ax.set_zlim(-1,1)
